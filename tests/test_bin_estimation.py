...
class TestCase1:
    ...
    def model(x, par):
        ...
        y[ind_2] = par[1]["b"] * (x[ind_2, 0] - par[1]["from"]) + par[1]["a"] + x[ind_2, 0] * x[ind_2, 1]
        y[ind_3] = par[2]["b"] * (x[ind_3, 0] - par[2]["from"]) + par[2]["a"] + x[ind_3, 0] * x[ind_3, 1]
        y[ind_4] = par[3]["b"] * (x[ind_4, 0] - par[3]["from"]) + par[3]["a"] + x[ind_4, 0] * x[ind_4, 1]

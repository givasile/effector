...
plot_subregions(splits=reg.splts_per_feature_only_important, feat=3, feat_ram=[3, 4], X_train=X_train, model=model, model_jac=model_jac, gam=gam_no_int, ram=ram_no_int)

...
#                            uncertainty=True)
# if savefig:
#     pathname = os.path.join(path, "example_2", "dale_fixed_bins.png")
...
y, var, stderr = dale.eval(x=np.linspace(axis_limits[0,0], axis_limits[1,0], 100),
                           ...
                           uncertainty=True)
if savefig:
    pathname = os.path.join(path, "example_2", "dale_feat_0.png")
    dale.plot(s=0, error="std", savefig=pathname)
    pathname = os.path.join(path, "example_2", "dale_feat_1.png")
    dale.plot(s=1, error="std", savefig=pathname)
    pathname = os.path.join(path, "example_2", "dale_feat_2.png")
...
pdp_ice = fe.PDPwithICE(data=X,
                        ...
                        axis_limits=axis_limits)
if savefig:
    pathname = os.path.join(path, "example_2", "pdp_ice_feat_0.png")
    pdp_ice.plot(s=0, normalized=True, nof_points=300, savefig=pathname)
    pathname = os.path.join(path, "example_2", "pdp_ice_feat_1.png")
    pdp_ice.plot(s=1, normalized=True, nof_points=300, savefig=pathname)
    pathname = os.path.join(path, "example_2", "pdp_ice_feat_2.png")

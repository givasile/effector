...
- [Example 4(a) - A conditional interaction model: global effects](./notebooks/synthetic-examples/05_conditional_interaction_independent_uniform_global.md)
- [Example 4(b) - A conditional interaction model: heterogeneity](./notebooks/synthetic-examples/05_conditional_interaction_independent_uniform_heter.md)

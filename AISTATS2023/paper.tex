...
correct interpretation could be resolved, if the FE method informs
about the heterogeneity of instance-level explanations, a quantity we
refer to as the \emph{uncertainty of the effect}.

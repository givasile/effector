...
\begin{figure}[h]
  \centering
  \includegraphics[width=.23\textwidth]{example_1/dale_feat_0.png}
  \includegraphics[width=.23\textwidth]{example_1/pdp_ice_feat_0.png}
  \caption{Feature effect for \(x_1\); NAME method at the left and PDP
    with ICE at the right.}
  \label{fig:synth-ex-1-case-1}
\end{figure}

\paragraph{No Uncertainty, Different weights.}

As before, there is no interaction term, i.e. \(\alpha=0\), and
uncertainty about the value of \(x_2\), i.e.  \(x_2 = x_1\), but we
give different weight to each feture \(a_1=2, a_2=0.5\). Again, we
observe that ALE quantifies perfectly the ground truth effect and the
zero-uncertainty in contrast to PDP with ICE.

\begin{figure}[h]
  \centering
  \includegraphics[width=.23\textwidth]{example_2/dale_feat_0.png}
  \includegraphics[width=.23\textwidth]{example_2/pdp_ice_feat_0.png}
  \caption{Figure 1}
...
set equal weights \(a_1=a_2=1\). In contrast with above, the
interaction term provokes heterogeneous effects for features
\(x_1, x_3\); at any position \(x_1\), the local effects dependend on
the unknown value of \(X_3\) and vice-versa. The effect of \(x_2\)
continues to have zero-uncertainty, since it does not appear in any
interaction term. NAME captures perfectly the effect of all features,
and the uncertainty in the case of \(x_1, x_2\). On the contrary,
PDP-ICE quantify the effect and the uncertainty correctly only in the
case of \(x_3\). For all other features, both the average effect and
the uncertainty implied by ICE plots are wrong.

\begin{figure}[h]
  \centering
  \includegraphics[width=.23\textwidth]{example_3/dale_feat_0.png}
  \includegraphics[width=.23\textwidth]{example_3/pdp_ice_feat_0.png}\\
  \includegraphics[width=.23\textwidth]{example_3/dale_feat_1.png}
  \includegraphics[width=.23\textwidth]{example_3/pdp_ice_feat_1.png}\\
  \includegraphics[width=.23\textwidth]{example_3/dale_feat_2.png}
  \includegraphics[width=.23\textwidth]{example_3/pdp_ice_feat_2.png}\\
  \caption{Figure 1}
  \label{fig:ex-synth-1-1}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.23\textwidth]{example_bin_splitting_1/fig_1.jpg}
  \includegraphics[width=.23\textwidth]{example_bin_splitting_1/fig_2.jpg}\\
  \includegraphics[width=.23\textwidth]{example_bin_splitting_1/fig_3.jpg}
  \includegraphics[width=.23\textwidth]{example_bin_splitting_1/fig_4.jpg}
  \caption{Figure 1}
  \label{fig:ex-synth-1-1}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.23\textwidth]{example_bin_splitting_2/fig_1.jpg}
  \includegraphics[width=.23\textwidth]{example_bin_splitting_2/fig_2.jpg}\\
  \includegraphics[width=.23\textwidth]{example_bin_splitting_2/fig_3.jpg}
  \includegraphics[width=.23\textwidth]{example_bin_splitting_2/fig_4.jpg}
  \caption{Figure 1}
  \label{fig:ex-synth-1-1}
\end{figure}

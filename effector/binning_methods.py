...
def find_limits(
    ...
    if isinstance(binning_method, Fixed):
        ...
        bin_est.find(
            nof_bins=binning_method.nof_bins,
            min_points=binning_method.min_points_per_bin,
            cat_limit=binning_method.cat_limit,
        )
        ...
        bin_est.find(
            min_points=binning_method.min_points_per_bin,
            init_nof_bins=binning_method.max_nof_bins,
            discount=binning_method.discount,
            cat_limit=binning_method.cat_limit,
        )
        ...
        bin_est.find(
            min_points=binning_method.min_points_per_bin,
            max_nof_bins=binning_method.max_nof_bins,
            discount=binning_method.discount,
            cat_limit=binning_method.cat_limit,
        )
